...
export class VoiceNotesSettingTab extends PluginSettingTab {
  ...
  private async renderTemplateSettings(containerEl: HTMLElement): Promise<void> {
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        'Template for synced notes. Available variables: {{recording_id}}, {{title}}, {{date}}, {{duration}}, {{created_at}}, {{updated_at}}, {{tags}}, {{transcript}}, {{embedded_audio_link}}, {{audio_filename}}, {{summary}}, {{tidy}}, {{points}}, {{todo}}, {{email}}, {{tweet}}, {{blog}}, {{custom}}, {{team_summary}}, {{parent_note}} and {{related_notes}}'
      )
